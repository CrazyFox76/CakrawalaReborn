...
const tagColors: Record<string, string> = {
  Populer: "bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300",
  Hot: "bg-orange-100 text-orange-700 dark:bg-orange-900/40 dark:text-orange-300",
  Eksklusif: "bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-300",
  Terbaik: "bg-yellow-100 text-yellow-700 dark:bg-yellow-900/40 dark:text-yellow-300",
};

// ─── Main Component ────────────────────────────────────────────────────────────
export default function CakraPoints({ stats, rewards }: Props) {
  return (
    <section
      id="cakrapoints"
            ...
            {rewards.map((reward) => (
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-4">
                    {/* Tag */}
                    <span className={`self-start rounded-full px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wider ${tagColors[reward.tag] || tagColors.Populer} mb-2`}>
                      {reward.tag}
                    </span>
                    ...
                    <div className="mt-auto pt-3 flex items-center justify-between">
                      <div className="flex items-center gap-1 text-blue-600 dark:text-blue-400">
                        ...
                        <span className="text-sm font-extrabold">{reward.points.toLocaleString("id-ID")} pts</span>
                      </div>
